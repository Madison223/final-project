...
/* This project is designed to give the student experience in programming a

solution to a real world problem. This program can be written in C or C++ and must be at least 500

lines of code total between all the files. It must be available as open source on Github and will be

graded by the instructor “get” the source code from Github, compiling, and executing the program
